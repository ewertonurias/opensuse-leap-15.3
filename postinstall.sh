...
# Update MozillaFirefox from Mozilla repositories
...
# Adding Emulators repository and install PCSX2
printf "\nEtapa 8/9: Adicionando repositório de emuladores e instalando PCSX2... \n"
